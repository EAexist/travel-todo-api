...
const STAGES = [
    ...
    { duration: '40s', target: 100, is_target: "true" },
    { duration: '40s', target: 150, is_target: "true" },
    { duration: '40s', target: 200, is_target: "true" },
    { duration: '40s', target: 250, is_target: "true" },
]
...
export const options = {
    ...
    thresholds: {
        ...
        'http_req_duration{stage:2}': [{ threshold: 'p(95)<10000', abortOnFail: true }],
        'http_req_failed{stage:2}': [{ threshold: 'rate<0.05', abortOnFail: true }],
        ...
        'http_req_duration{stage:4}': [{ threshold: 'p(95)<10000', abortOnFail: true }],
        'http_req_failed{stage:4}': [{ threshold: 'rate<0.05', abortOnFail: true }],
    },
};

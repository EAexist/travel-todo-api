...
const STAGES = [
    ...
    { duration: '1m20s', target: 40, is_target: "true" },
    { duration: '40s', target: 80, },
    { duration: '1m20s', target: 80, is_target: "true" },
    { duration: '40s', target: 120, },
    { duration: '1m20s', target: 120, is_target: "true" },
    { duration: '40s', target: 160, },
    { duration: '1m20s', target: 160, is_target: "true" },
]
...
export const options = {
    ...
    thresholds: {
        'dropped_iterations{stage:1}': [{ threshold: 'rate<0.1', abortOnFail: true }],
        'dropped_iterations{stage:3}': [{ threshold: 'rate<0.1', abortOnFail: true }],
        'dropped_iterations{stage:5}': [{ threshold: 'rate<0.1', abortOnFail: true }],
        'dropped_iterations{stage:7}': [{ threshold: 'rate<0.1', abortOnFail: true }],
        ...
        'http_req_duration{stage:3}': [{ threshold: 'p(95)<10000', abortOnFail: true }],
        'http_req_failed{stage:3}': [{ threshold: 'rate<0.05', abortOnFail: true }],
        'http_req_duration{stage:5}': [{ threshold: 'p(95)<10000', abortOnFail: true }],
        'http_req_failed{stage:5}': [{ threshold: 'rate<0.05', abortOnFail: true }],
        'http_req_duration{stage:7}': [{ threshold: 'p(95)<10000', abortOnFail: true }],
        'http_req_failed{stage:7}': [{ threshold: 'rate<0.05', abortOnFail: true }],
    },
};

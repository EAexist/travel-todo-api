...
@ContextConfiguration(classes = {UserAccountMapperImpl.class, TripMapperImpl.class})
...
public class UserAccountMapperTest {
  ...
  @Autowired private UserAccountDTO userAccountDTO;

  @MockitoBean private StockTodoContentRepository stockTodoContentRepository;

  @MockitoBean private TodoMapper todoMapper;

  @InjectMocks private TripMapperImpl tripMapper;
  ...
  void mapToUserAccountDTO_Given_userAccountWithEmptyTrip_When_mapped_Then_correctUserAccountDTO() {
    ...
    assertThat(mappedUserAccountDTO)
        .usingRecursiveComparison()
        .ignoringFields("id")
        .isEqualTo(userAccountDTO);
  }
}

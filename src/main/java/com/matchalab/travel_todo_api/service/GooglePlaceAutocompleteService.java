...
public class GooglePlaceAutocompleteService {
  ...
  @Autowired private final GooglePlaceClientService googlePlaceClientService;
  ...
  public GooglePlaceAutoCompleteResponse googlePlaceAutocomplete(
    ...
    if (!containsHangul(input)) {
      ...
      GooglePlaceAutoCompleteResponse response = googlePlaceClientService.autocomplete(input, language, type);

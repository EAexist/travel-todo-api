...
import com.matchalab.travel_todo_api.model.genAI.*;
...
public class MockChatModelService implements ChatModelService {
  ...
  public ExtractReservationChatResultDTO extractReservationFromText(String confirmationText) {
    ...
    ExtractReservationChatResultDTOBuilder builder =
        ExtractReservationChatResultDTO.builder()
        ...
        return RecommendedFlightChatResult.builder()
            .recommendedOutboundFlight(
                List.of(
                    FlightRouteWithoutAirline.builder()
                        .departureAirportIataCode("ICN")
                        .arrivalAirportIataCode("CJU")
                        .build(),
                    FlightRouteWithoutAirline.builder()
                        .departureAirportIataCode("GMP")
                        .arrivalAirportIataCode("CJU")
                        .build()))
            .recommendedReturnFlight(
                List.of(
                    FlightRouteWithoutAirline.builder()
                        .departureAirportIataCode("CJU")
                        .arrivalAirportIataCode("ICN")
                        .build(),
                    FlightRouteWithoutAirline.builder()
                        .departureAirportIataCode("CJU")
                        .arrivalAirportIataCode("GMP")
                        .build()))
            .build();
      default:
        return RecommendedFlightChatResult.builder().build();
    }
  }

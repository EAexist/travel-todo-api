...
public class TripController {
  ...
  public ResponseEntity<TripDTO> patchTrip(
      @PathVariable UUID tripId, @RequestBody TripPatchDTO newTripDTO) {
    try {
  ...
  /**
   * Add a destination to the Trip's destination list. If the destination doesn't exist in databse,
   * create new one.
   */
  @PostMapping("trip/{tripId}/destination")
  public ResponseEntity<DestinationDTO> addDestination(
      @PathVariable UUID tripId, @RequestBody DestinationDTO requestedDestinationDTO) {
    try {
  ...
  /**
   * Delete a destination from the Trip's destination list. This does not remove the destination
   * from the database.
   */
  @DeleteMapping("trip/{tripId}/destination/{destinationId}")
  public ResponseEntity<Void> deleteDestination(
      @PathVariable UUID tripId, @PathVariable UUID destinationId) {
    try {

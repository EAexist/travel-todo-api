...
import com.matchalab.travel_todo_api.model.UserAccount.KakaoProfile;
...
public class AuthController {
  ...
  /** Provide the details of an Trip with the given id. */
  @PostMapping("/kakao")
  public ResponseEntity<UserAccountDTO> kakaoLogin(
      Authentication auth, @RequestBody KakaoProfile kakaoProfile) {
    try {
      ...
      UserAccount userAccount =
          userOptional.orElse(
              userAccountRepository.save(new UserAccount(auth.getName(), kakaoProfile)));

      UserAccountDTO userAccountDTO =
          userAccountMapper.mapToUserAccountDTO(
  ...
  public ResponseEntity<UserAccountDTO> webBrowserLogin(

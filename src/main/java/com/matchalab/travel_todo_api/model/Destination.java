...
public class Destination {
  ...
  @JoinTable(
      name = "destination_outbound",
      joinColumns = @JoinColumn(name = "destination_id"),
      inverseJoinColumns = @JoinColumn(name = "flight-route_id"))
  ...
  public Destination(String title, String iso2DigitNationCode, String region, String description) {
    this();
    this.title = title;
